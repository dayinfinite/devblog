...
from .forms import LoginForm, RegistrationForm, ChangeEmailForm, PasswordRestRequstForm, PasswordResetForm, \
    changePasswordForm
...
def login():
    ...
    return render_template('auth/lgin.html', form=form)
...
def change_email_request():
    ...
    if form.validate_on_submit():
        if current_user.verify_password(form.password.data):
            ...
            flash('An email with instrutions to confirm your new email address has been sent to you')
            return redirect(url_for('main.index'))
        else:
